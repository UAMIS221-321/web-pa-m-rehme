...
function handleEditClick(){
    ...
    buttonHtml += "<button class=\"btn btn-warning btn-lg button-cancel\" onclick=\"handleCancelSave()\">Cancel</button>"
...
function handleNewClick(){
    ...
    hideButtons();
    blankFields();
    var buttonHtml = "<button class=\"btn btn-primary btn-lg\" onclick=\"handleNewSave("+myBook.id+")\">Save</button>"
    buttonHtml += "<button class=\"btn btn-warning btn-lg button-cancel\" onclick=\"handleCancelSave()\">Cancel</button>"
    document.getElementById("saveButton").innerHTML = buttonHtml;
    document.getElementById("saveButton").style.display = "inline-block";
